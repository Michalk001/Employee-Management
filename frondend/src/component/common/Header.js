        ...
        <div className="header">
            <div className="header--wrap">
                <Link to="/" className="header__home">
                    ...
                    <div className="header__home--text  header__home--transition">{t('common.home')}</div>
                </Link>
                ...
                <div className="header__menu">
                    ...
                    {authContext.isLogin && authContext.userDate && <Link to={`/user/${authContext.userDate.username}`} className="header__text header__text--link header__item"> {authContext.userDate.firstname} {authContext.userDate.lastname}</Link>}
